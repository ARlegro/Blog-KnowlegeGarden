---
{"dg-publish":true,"permalink":"/DevStudy/Backend/RM/websocket_stomp/STOMP + WebSocket으로 실시간 알림/0. 기본 R.M설정 및 webSocket 연결/","noteIcon":"","created":"2025-12-03T14:52:49.942+09:00","updated":"2025-12-13T10:20:54.646+09:00"}
---
...
flowchart LR
client --> |webSocket 연결|server
```

![Pasted image 20250617220834.png](/img/user/supporter/image/Pasted%20image%2020250617220834.png)


#### 0.1.1.  설정 

gradle에 websocket 추가 
```yaml
implementation 'org.springframework.boot:spring-boot-starter-websocket'
```

#### 0.1.2.  RabbitMQ.Config 
```java 
...
3. **메시지 구독 (Subscribe) - `stompClient.subscribe('/topic/notifications ~`**
	...
	- **function (message)** : 메시지가 수신되었을 때 실행되는 콜백 함수
		...
		- STOMP 메시지를 예시.  ([[DevStudy/Backend/RM/websocket_stomp/Spring Messaging\|Spring Messaging]])
		```javascript
		{
				command: 'MESSAGE',
				headers: { ... },   
