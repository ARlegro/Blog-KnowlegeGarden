---
{"dg-publish":true,"permalink":"/DevStudy/Backend/Spring/Security/JWT/0. Start/","noteIcon":"","created":"2025-05-31T10:01:46.515+09:00","updated":"2025-12-24T21:32:29.170+09:00"}
---


## 1.  일반적인 방식의 Token Formats
APP에 로그인 하면 브라우저에 JSESSIONID랑 XSRF-TOKEN이 있을 것이다.
이 2개의 Cookies는 rqeust시 자동으로 얻은 것 
XSRF-TOKEN 참고 : [[DevStudy/Backend/Spring/Security/CORS & CSRF/CSRF Solution\|CSRF Solution]]
...
### 2.1.  Opaque Tokens 단점
- token value는 의미가 없는 random String인데,
- token의 정보를 authorization server가 갖고 있다.
- 매번 요청마다 이 token을  authorization server에 보내서 검증을 해야한다
- 검증 요청 및 유저 info를 얻기 위해 API 엔드포인트 필요???(인증 서버의 introspection endpoint)

즉, Opaque Token 방식은 **authorization server에 너무 의존적**이다.
...
참고 : [[DevStudy/Backend/Spring/Security/JWT/1. Advantages of Tokens based AuthN\|1. Advantages of Tokens based AuthN]]
...
![supporter/image/PDF 19.png](/img/user/supporter/image/PDF%2019.png)
1. Header
2. Payload
...
![supporter/image/PDF 20.png](/img/user/supporter/image/PDF%2020.png)
...
![supporter/image/PDF 21.png](/img/user/supporter/image/PDF%2021.png)

이것도 Base64를 통해 encoding 


### 4.3.  Signature (digital)
This is Optional
...
![supporter/image/PDF 22.png](/img/user/supporter/image/PDF%2022.png)



Next 
- [[DevStudy/Backend/Spring/Security/JWT/1. Advantages of Tokens based AuthN\|1. Advantages of Tokens based AuthN]]
- [[DevStudy/Backend/Spring/Security/JWT/3. Building Logic to generate, validate JWT\|3. Building Logic to generate, validate JWT]]
