---
{"dg-publish":true,"permalink":"/DevStudy/Backend/Spring/Security/JWT/2. Config to use JWT/","noteIcon":"","created":"2025-05-31T10:01:46.529+09:00","updated":"2025-12-24T21:28:18.866+09:00"}
---

## 1.  Step1. jjwt 라이브러리 추가 
...
---
## 2.  Step2. SessionCreationPolicy 변경 (`ALWAYS` ➡ `STATELESS`)
...
---
## 3.  Step3. securityContext Config 제거 
JWT 기반 인증에서는 `SecurityContext`에 사용자의 인증 정보를 보관할 필요가 없다.
...
### 3.1.  Step3. JWT 관련 custom filter추가 
>[!tip]  계획
...
---
## 4.  Step4. cors config 수정 - AllowedHeaders
