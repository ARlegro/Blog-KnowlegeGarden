---
{"dg-publish":true,"permalink":"/DevStudy/Backend/Spring/Security/JWT/3. Building Logic to generate, validate JWT/","noteIcon":"","created":"2025-05-31T10:01:46.536+09:00","updated":"2025-12-24T21:29:10.240+09:00"}
---
...
---
### 1.2.  JWT 생성 로직 (Spring Security 필터 안에서)
```JAVA
@Override  
...
`UsernamePasswordAuthenticationToken`는 파라미터 3개짜리로 생성하면 **Authentication이 자동**으로 된다. 따라서 인증과정 불필요 
```java
[when 2 param]
...
Next 
- [[DevStudy/Backend/Spring/Security/JWT/4. Change front-code for JWT\|4. Change front-code for JWT]]
- [[DevStudy/Backend/Spring/Security/JWT/5. Testing JWT token\|5. Testing JWT token]]
