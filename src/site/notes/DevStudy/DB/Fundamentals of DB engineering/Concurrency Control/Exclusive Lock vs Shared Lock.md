---
{"dg-publish":true,"permalink":"/DevStudy/DB/Fundamentals of DB engineering/Concurrency Control/Exclusive Lock vs Shared Lock/","noteIcon":"","created":"2025-12-03T14:52:51.095+09:00","updated":"2025-12-13T10:57:46.190+09:00"}
---
...
## 3.  상호 배제 규칙 
- `Exclusive Lock`을 획득하려면, 해당 데이터에 **어떤 `Shared Lock`도 걸려 있지 않아야 한다.**
- `Shared Lock`을 획득하려면, 해당 데이터에 **어떤 `Exclusive Lock`도 걸려 있지 않아야 한다.**
