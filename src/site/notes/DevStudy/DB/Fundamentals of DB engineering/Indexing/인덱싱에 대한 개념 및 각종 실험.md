---
{"dg-publish":true,"permalink":"/DevStudy/DB/Fundamentals of DB engineering/Indexing/인덱싱에 대한 개념 및 각종 실험/","noteIcon":"","created":"2025-06-08T14:27:47.720+09:00","updated":"2025-12-07T20:48:01.781+09:00"}
---
...
- [[#2.  성능 비교하기 전 세팅 : 인덱싱 O or X|2.  성능 비교하기 전 세팅 : 인덱싱 O or X]]
	- [[#2.  성능 비교하기 전 세팅 : 인덱싱 O or X#2.1.  기본 세팅 및 분석|2.1.  기본 세팅 및 분석]]
	- [[#2.  성능 비교하기 전 세팅 : 인덱싱 O or X#2.2.  더미 데이터 - 100만|2.2.  더미 데이터 - 100만]]
	- [[#2.  성능 비교하기 전 세팅 : 인덱싱 O or X#2.3.  EXPLAIN ANALYZE 도입|2.3.  EXPLAIN ANALYZE 도입]]
- [[#3.  본격 실험|3.  본격 실험]]
	- [[#3.  본격 실험#3.1.  시나리오 1. Index Only Scan|3.1.  시나리오 1. Index Only Scan]]
	- [[#3.  본격 실험#3.2.  시나리오 2. name 조회하기|3.2.  시나리오 2. name 조회하기]]
		- [[#3.2.  시나리오 2. name 조회하기#3.2.1.  실행|3.2.1.  실행]]
		- [[#3.2.  시나리오 2. name 조회하기#3.2.2.  느린 이유 분석|3.2.2.  느린 이유 분석]]
	- [[#3.  본격 실험#3.3.  시나리오 3. name을 WHERE 절에 사용 🔐|3.3.  시나리오 3. name을 WHERE 절에 사용 🔐]]
	- [[#3.  본격 실험#3.4.  ⛔LIKE 쿼리가 안 좋은 이유|3.4.  ⛔LIKE 쿼리가 안 좋은 이유]]
- [[#4.  인덱스 도입|4.  인덱스 도입]]
	- [[#4.  인덱스 도입#4.1.  인덱스 만들기|4.1.  인덱스 만들기]]
	- [[#4.  인덱스 도입#4.2.  만약 인덱스 + Like를 쓴다면?|4.2.  만약 인덱스 + Like를 쓴다면?]]
