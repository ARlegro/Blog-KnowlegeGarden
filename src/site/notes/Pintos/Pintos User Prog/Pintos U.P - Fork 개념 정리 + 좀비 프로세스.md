---
{"dg-publish":true,"permalink":"/Pintos/Pintos User Prog/Pintos U.P - Fork 개념 정리 + 좀비 프로세스/","noteIcon":"","created":"2025-12-03T16:03:22.625+09:00","updated":"2025-12-03T16:08:46.685+09:00"}
---
...
- [[#1.  Fork란|1.  Fork란]]
- [[#2.  Fork 동작 과정|2.  Fork 동작 과정]]
	- [[#2.  Fork 동작 과정#2.1.  부모 프로세스가 할 일|2.1.  부모 프로세스가 할 일]]
	- [[#2.  Fork 동작 과정#2.2.  자식 프로세스가 할 일|2.2.  자식 프로세스가 할 일]]
- [[#3.  Fork 특징|3.  Fork 특징]]
	- [[#3.  Fork 특징#3.1.  Copy-on-Write(COW)|3.1.  Copy-on-Write(COW)]]
	- [[#3.  Fork 특징#3.2.  자식과 부모는 독립적|3.2.  자식과 부모는 독립적]]
	- [[#3.  Fork 특징#3.3.  자식은 부모 프로스의 자원을 그대로 물려받음|3.3.  자식은 부모 프로스의 자원을 그대로 물려받음]]
- [[#4.  Fork 시 ...|4.  Fork 시 ...]]
	- [[#4.  Fork 시 ...#4.1.  좀비 프로세스|4.1.  좀비 프로세스]]
		- [[#4.1.  좀비 프로세스#4.1.1.  발생 원리 예시|4.1.1.  발생 원리 예시]]
		- [[#4.1.  좀비 프로세스#4.1.2.  좀비 프로세스가 문제인 이유 (실제 OS기준)|4.1.2.  좀비 프로세스가 문제인 이유 (실제 OS기준)]]
		- [[#4.1.  좀비 프로세스#4.1.3.  좀비를 안남기는 핵심 로직 - wait()|4.1.3.  좀비를 안남기는 핵심 로직 - wait()]]
	- [[#4.  Fork 시 ...#4.2.  고아 프로세스|4.2.  고아 프로세스]]
- [[#5.  fork()를 사용한 프로세스 생성|5.  fork()를 사용한 프로세스 생성]]
	- [[#5.  fork()를 사용한 프로세스 생성#5.1.  fork() 호출 과정|5.1.  fork() 호출 과정]]
- [[#6.  execve()|6.  execve()]]
